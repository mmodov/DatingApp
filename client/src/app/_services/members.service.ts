...
export class MembersService {
  ...
  getMembers(userParams: UserParams) {
    ...
    return getPaginatedResut<Member[]>(this.baseUrl + 'users', params, this.http).pipe(map( response => {
  ...
  getLikes(predicate: string, pageNumber, pageSize) 
  {
    ...
    return getPaginatedResut<Partial<Member[]>>(this.baseUrl + 'likes', params, this.http);
  }
}
