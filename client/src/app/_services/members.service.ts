...
export class MembersService {
  ...
  getMembers(userParams: UserParams) {
    ...
    return this.getPaginatedResut<Member[]>(this.baseUrl + 'users', params).pipe(map( response => {
  ...
  getLikes(predicate: string, pageNumber, pageSize) 
  {
    ...
    return this.getPaginatedResut<Partial<Member[]>>(this.baseUrl + 'likes', params);
  }
}
